...
class AgentRunner:
    ...
    async def run_and_capture(
        ...
        *,
        ...
        project_system_prompt = load_context_file(Path(".kama/system_prompt.md"))
        effective_system_prompt = system_prompt_override or project_system_prompt or None
        ...
        async with EventWriter(run_path / "events.jsonl") as writer:
            ...
            try:
                ...
                loop_cls = (
                    PlanExecuteLoop
                    if self._config.agent.mode == "plan_execute"
                    else AgentLoop
                )
                loop = loop_cls(
                    provider,
